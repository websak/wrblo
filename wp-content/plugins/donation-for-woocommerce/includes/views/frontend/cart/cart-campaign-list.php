...
<div class="wc-donation-in-action" data-donation-type="<?php echo esc_attr( $display_donation ); ?>">
	<div class="in-action-elements">
		<div class="list-campaign-thumbnail">
		...
		<div class="list-campaign-data">
			<div class="list-campaign-title-description-goal">
				<div class="list-campaign-title-descrption">
			...
			<div class="list-campaign-amount-cause-donate">
				<?php 
				if ( is_array( $blocks ) && count( $blocks ) > 0 ) {
					foreach ( $blocks as $block ) {
						?>
						<div class="list-campaign-<?php echo esc_attr($block); ?>">
						<?php
