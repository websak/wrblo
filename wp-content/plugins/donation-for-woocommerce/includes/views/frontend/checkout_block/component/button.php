<div class="wc-donation-donate-btn">
	<button type="button" class="wc-donation-donate" <?php echo isset($event) ? wp_kses($event, array( 'onclick' => true )) : ''; ?>>
		<div class="button-text">
			<?php echo wp_kses_post(sprintf('Continue to Donate <span class="amount"></span>')); ?>
		</div>
