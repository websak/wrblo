...
if ( false !== $report_ids && is_array( $report_ids ) ) {
	...
	*  @since 3.6
	*/
	$_title = apply_filters('anonymous_donor_list_title', $_title);
	?>
	<div class="anonymous-donor-lists-wrapper">
		<?php
		...
		<div class="give-wrap give-grid-ie-utility">
			<div class="give-grid give-grid--3 anonymous-donor-lists">
				<?php
				$count = 0;
