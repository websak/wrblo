...
if ( ! class_exists( 'EdgeCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class EdgeCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'edge-cpt/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'goodwish_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	EdgeCoreDashboardRestAPI::get_instance();
}