<?php
if ( ! function_exists( 'goodwish_edge_init_google_fonts_array' ) ) {
    function goodwish_edge_init_google_fonts_array() {
        ...
        $goodwish_edge_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'goodwish_edge_init_google_fonts_array');
}