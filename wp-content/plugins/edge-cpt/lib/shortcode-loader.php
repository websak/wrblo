...
use EdgeCore\CPT\MasonryGallery;
use EdgeCore\PostTypes\Event;
...
class ShortcodeLoader {
    ...
    private function addShortcodes() {
        ...
        $this->addShortcode(new Event\Shortcodes\EventList());
        $this->addShortcode(new Event\Shortcodes\EventInfo());
    }
