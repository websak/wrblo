...
class Carousel implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map( array(
            ...
            'params' => array(
                ...
                array(
                    'type' => 'dropdown',
                    'heading' => esc_html__('Show navigation?', 'edge-cpt'),
    ...
    public function render($atts, $content = null) {
        ...
        if ($carousel !== '') {
            ...
            $html .= '<div class="edgtf-carousel edgtf-slick-slider-navigation-style" ' .  goodwish_edge_get_inline_attrs($carousel_data_attributes) . '>';
