...
class EdgefInstagramApi {
	...
	const INSTAGRAM_CODE = 'edgtf_instagram_code';
	const INSTAGRAM_USER_ID = 'edgtf_instagram_user_id';
	const INSTAGRAM_TOKEN = 'edgtf_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'edgtf_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'edgtf_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'edgtf_facebook_code';
	const FACEBOOK_TOKEN = 'edgtf_facebook_access_token';

	const CONNECTION_TYPE = 'edgtf_connection_type';
	 ...
	 * @return stdClass
	 *
	 * @see EdgefInstagramApi::instagramExchangeCodeForToken()
	 */
