...
window.vc||(window.vc={}),(n=>{var e=Backbone.Model.extend({defaults:{formData:{keyphrase:"",title:"",description:"",slug:"",isUsedKeyphrase:""},formDataPrevious:{keyphrase:"",title:"",description:"",slug:"",isUsedKeyphrase:""},results:[]},setResults:function(e,t,s){var r,i,a=this.get(s);"focus-keyphrase"!==t&&"keyphrase"!==t||(t="keyphrase",e&&e!==this.get(s).keyphrase&&(r=this,i={action:"wpb_seo_check_key_phrase",key_phrase:e,post_id:window.vc_post_id,_vcnonce:window.vcAdminNonce},n.ajax({type:"POST",url:window.ajaxurl,data:i}).done(function(e){e.success&&(a.isUsedKeyphrase=e.data,r.set(s,a),r.trigger("formData","change",a))}).fail(function(e){console.error("Failed to get the previously used keyphrase response: "+e)}))),a[t]=e,this.set(s,a),"formData"===s&&this.trigger("formData","change",a)},updateResult:function(e,t,s){var r={state:e,title:t,description:s},e=this.get("results").slice(),t=e.findIndex(function(e){return e.title===r.title});-1!==t?(e[t]=r,this.trigger("resultChanged","update",r)):(e.push(r),this.trigger("resultChanged","add",r)),this.set("results",e)},resetResult:function(t){var e=this.get("results").filter(function(e){return e.title!==t});this.set("results",e)}});vc.seo_storage=new e})(window.jQuery);
...
window.vc||(window.vc={}),(s=>{var c="formData",a="formDataPrevious";window.vc.PostSettingsSeoUIPanel=vc.PostSettingsSeoUIPanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).extend({el:"#vc_ui-panel-post-seo",panelName:"post_seo",events:{'click [data-vc-ui-element="button-close"]':"hide",'touchstart [data-vc-ui-element="button-close"]':"hide",'click [data-vc-ui-element="panel-tab-control"]':"changeTab",'click [data-vc-ui-element="button-save"]':"save",'click [data-vc-ui-element="button-minimize"]':"toggleOpacity","change #vc_ui-seo-social .gallery_widget_attached_images_ids":"updateImagePreview","input #social-title-x, #social-title-facebook":"updateTitlePreview","input #social-description-x, #social-description-facebook":"updateDescriptionPreview","click #preview-dots, #vc_seo-title, #vc_description-container":"focusTarget",'change .vc-preview-radio input[type="radio"]':"changePreviewMode","input #vc_seo-title-field, #vc_seo-description-field, #vc_seo-slug-field":"updateGeneralPreviewText","blur #vc_seo-title-field, #vc_seo-description-field":"fillSocialInputs","change #vc_focus-keyphrase-field, #vc_seo-title-field, #vc_seo-description-field, #vc_seo-slug-field, #social-title-facebook, #social-description-facebook, #social-title-x, #social-description-x":"handleInputChange"},initialize:function(){_.bindAll(this,"fixElContainment","setSize"),this.on("setSize",this.setResize,this),this.setFormDataState()},render:function(){this.$el.is(":hidden")&&vc.closeActivePanel(),(vc.active_panel=this).show()},show:function(){var e;this.$el.hasClass("vc_active")||(this.$el.addClass("vc_active"),this.draggable||this.initDraggable(),this.fixElContainment(),this.trigger("show"),(e=this.$el.find(".vc_panel-tab")).length&&(this.$tabs=e))},hide:function(e){if(this.isSeoSettingsChanged()){if(!confirm(window.i18nLocale.page_settings_confirm))return;vc.PanelView.prototype.hide.call(this,e),this.rollBackChanges()}else vc.PanelView.prototype.hide.call(this,e);vc.PanelView.prototype.hide.call(this,e),this.trigger("hide")},isSeoSettingsChanged:function(){var e=vc.seo_storage.get(c),t=vc.seo_storage.get(a);return!_.isEqual(e,t)},rollBackChanges:function(){var e,t=vc.seo_storage.get(a),i=s("#vc_setting-seo-form");for(e in t)t.hasOwnProperty(e)&&(vc.seo_storage.setResults(t[e],e,c),i.find('[name="'+("keyphrase"===e?"focus-keyphrase":e)+'"]').val(t[e]))},changeTab:function(e){e.preventDefault();e=s(e.currentTarget).parent(),e.parent().find('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"),e.addClass("vc_active"),this.$tabs.filter(".vc_active").removeClass("vc_active"),e=e.data("tabIndex");this.$tabs.filter('[data-tab-index="'+e+'"]').addClass("vc_active")},updateImagePreview:function(e){var t,e=s(e.currentTarget).closest(".edit_form_line"),i=e.find(".inner img").attr("src"),e=e.attr("data-social-net-preview-slug");e&&i&&(i=i.replace("-150x150",""),(t=(e=s("#"+e)).find("img")).attr("src",i),t.show(),e.find(".wpb-social-placeholder-image").hide())},updateTitlePreview:function(e){e=s(e.currentTarget);e.closest(".vc_seo-social-block").find(".wpb-social-net-preview .vc_social-title").text(e.val())},updateDescriptionPreview:function(e){var e=s(e.currentTarget),t=e.closest(".vc_seo-social-block"),e=e.val();t.find(".wpb-social-net-preview .vc_social-description").text(e),t.find(".vc_social-description-counter").text(e.length)},focusTarget:function(e){e=s(e.currentTarget).data("focus");s("#"+e).focus()},changePreviewMode:function(e){var t=this.$el.find(".page-preview");"mobile"===s(e.currentTarget).val()?t.removeClass("desktop-view"):t.addClass("desktop-view")},updateGeneralPreviewText:function(e){var t=s(e.currentTarget).val(),e=("vc_seo-slug-field"===s(e.currentTarget).attr("id")&&(t=window.vc.utils.slugify(t),this.updatePostSettingsSlug(t)),s(e.currentTarget).data("preview")),e=this.$el.find("#"+e);e&&e.text(t)},updatePostSettingsSlug:function(e){s("#vc_post_name").val(e);var t=s(".wpb-post-url--slug");t&&t.text(e)},handleInputChange:function(e){var t=e.target.value.trim();vc.seo_storage.setResults(t,e.target.name,c)},setFormDataState:function(){this.$el.find("#vc_ui-seo-general").find('input[type="text"], textarea').each(function(e,t){var i=s(t).attr("name"),t=s(t).val();vc.seo_storage.setResults(t,i,c),vc.seo_storage.setResults(t,i,a)}),this.$el.find("#vc_ui-seo-social").find('input[type="text"], textarea').each(function(e,t){var i=s(t).attr("name"),t=s(t).val();vc.seo_storage.setResults(t,i,c),vc.seo_storage.setResults(t,i,a)})},fillSocialInputs:function(e){var t=s(e.currentTarget).val(),e=s(e.currentTarget).attr("name"),i=vc.seo_storage.get(c),a={title:["social-title-x","social-title-facebook"],description:["social-description-x","social-description-facebook"]};a[e]&&a[e].forEach(function(e){i[e]||(s("#"+e).val(t).trigger("input"),vc.seo_storage.setResults(t,e,c))})}})})(window.jQuery);
