...
class Vc_Modules_Manager {
	...
	public function get_plugin_module_list() {
		...
		return array_merge( $module_list, $this->get_depend_module_list() );
	}

	/**
	 * Get list of modules that depend on some conditions to include in plugin module list.
	 *
	 * @since 8.4
	 * @return array
	 */
	public function get_depend_module_list() {
		$modules_dir = vc_manager()->path( 'MODULES_DIR' );
		$list = [];
