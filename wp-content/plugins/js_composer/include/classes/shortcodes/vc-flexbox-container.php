<?php
/**
 * Class that handles specific [vc_flexbox_container] shortcode.
 *
 * @see js_composer/include/templates/shortcodes/vc_flexbox_container.php
 *
 * @since 8.7
 */
...
/**
 * Class WPBakeryShortCode_Vc_Flexbox_Container
 *
 * @since 8.7
 */
class WPBakeryShortCode_Vc_Flexbox_Container extends WPBakeryShortCode {
	/**
	...
	/**
	 * Get Flexbox container Backend editor output.
	 *
	 * @since 8.7
	 *
	 * @param array $atts
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		$output .= '<div class="vc_flexbox_container vc_container_for_children">';
	...
	/**
	 * Returns the CSS class for the flexbox container in the backend editor.
	 *
	 * @since 8.7
	 *
	...
	/**
	 * Returns the HTML for the flexbox container item controls in the backend editor.
	 *
	 * @since 8.7
	 *
