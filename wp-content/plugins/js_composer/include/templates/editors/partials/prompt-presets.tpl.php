...
<form class="vc_ui-prompt vc_ui-prompt-presets">
	...
	<div class="vc_ui-prompt-content">
		...
		<div class="vc_ui-prompt-column">
			<button type="buttom"
				class="vc_general vc_ui-button vc_ui-button-size-md vc_ui-button-action vc_ui-button-shape-rounded vc_preset-save-btn" id="vc_ui-save-preset-btn"><?php esc_html_e( 'Save changes', 'js_composer' ); ?></button>
		</div>
	</div>
</form>
