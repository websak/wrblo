<?php
/**
 * The template for displaying [vc_grid_container_item] shortcode output of 'Grid Item' element.
 *
 * This template can be overridden by copying it to yourtheme/vc_templates/vc_grid_container_item.php
 *
