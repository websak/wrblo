...
function tooltipGlobalSettings()
{
	...
	*/
	...
	//9.9.3
	if (isset($_POST['enablegutenbergfortooltipsSubmit']))
	{
		check_admin_referer('fucwpexpertglobalsettings');
	    if (isset($_POST['enablegutenbergfortooltips']))
	    {
	        $enablegutenbergfortooltips = sanitize_text_field($_POST['enablegutenbergfortooltips']);
	        update_option("enablegutenbergfortooltips",$enablegutenbergfortooltips);
...
<?php 
    ...
    // 9.9.3 $questiontip = "<div class=\'$admin_tip_content_classname\'><p>$admin_tip_content</p></div>";
...
//start 8.9.5
    ...
    $addtipto = "span.$paneltipspanclassname";
    $addtiptodiv = $admin_tip_content_classname;
    // before 9.9.3 $questiontip = "<div class=\'$admin_tip_content_classname\'><p>$admin_tip_content</p></div>";
	$questiontip = "<div class=".'"'.$admin_tip_content_classname. '"'."><p>$admin_tip_content</p></div>";
    $tipadsorbent = ".$paneltipspanclassname";
    $adminTip = showAdminTip($addtipto,$questiontip,"div.$admin_tip_content_classname",$tipadsorbent);
...
//end 8.9.5
	...
	//9.9.3 and 31.4.8 start

    $panel_title = __( "Enable / Disable Gutenberg for Tooltips", "wordpress-tooltips");
    $panel_label_content = __( "Enable Gutenberg for Tooltips: ", "wordpress-tooltips");
    $paneltipspanclassname = 'questionenablegutenbergfortooltips';
    $paneltipspanclass = " <span class='$paneltipspanclassname'>?</span>";
    $panel_label = $panel_label_content.$paneltipspanclass;
    $admin_tip_content = __('Opt to Enable / Disable Gutenberg Editor for Tooltips',  "wordpress-tooltips");
    $admin_tip_content_classname = "divenablegutenbergfortooltips";
    $addtipto = "span.$paneltipspanclassname";
    $addtiptodiv = $admin_tip_content_classname;
    //$questiontip = "<div class=\'$admin_tip_content_classname\'><p>$admin_tip_content</p></div>";
	//9.9.3
    ...
    $tipadsorbent = ".$paneltipspanclassname";
    $adminTip = showAdminTip($addtipto,$questiontip,"div.$admin_tip_content_classname",$tipadsorbent);
    $panel_submit_button_name = 'enablegutenbergfortooltipsSubmit';
    ...
    $panel_content = '<select id="enablegutenbergfortooltips" name="enablegutenbergfortooltips" style="width:300px;">';
    if ($enablegutenbergfortooltips == 'NO')
    {
        $panel_content .= '<option id="enablegutenbergfortooltipsOption" value="NO"  selected="">'. __("NO, disable Gutenberg for tooltips", "wordpress-tooltips"). "</option>";
    }
    else
    {
        $panel_content .= '<option id="enablegutenbergfortooltipsOption" value="NO">'. __("NO, disable Gutenberg for tooltips", "wordpress-tooltips"). "</option>";
    }
    
    
    if ($enablegutenbergfortooltips == 'YES')
    {
        $panel_content .= '<option id="enablegutenbergfortooltipsOption" value="YES" selected="">'. __('Yes, enable Gutenberg for tooltips', "wordpress-tooltips") . "</option>";
    }
    else
    {
        $panel_content .= '<option id="enablegutenbergfortooltipsOption" value="YES">'. __('Yes, enable Gutenberg for tooltips', "wordpress-tooltips") . "</option>";
    }
