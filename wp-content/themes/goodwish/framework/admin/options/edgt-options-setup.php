...
add_action('after_setup_theme', 'goodwish_edge_admin_map_init', 0);

function goodwish_edge_admin_map_init() {

    do_action('goodwish_edge_before_options_map');
    ...
    do_action('goodwish_edge_options_map');

    do_action('goodwish_edge_after_options_map');
