...
/*
  Class: GoodwishEdgeIconCollections
...
class GoodwishEdgeIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new GoodwishEdgeIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new GoodwishEdgeIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ico_moon', new GoodwishEdgeIcoMoonIcons('Ico Moon', 'ico_moon'));
        $this->addIconCollection('ion_icons', new GoodwishEdgeIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new GoodwishEdgeLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('linear_icons', new GoodwishEdgeLinearIcons('Linear Icons', 'linear_icons'));
        $this->addIconCollection('simple_line_icons', new GoodwishEdgeSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('dripicons', new GoodwishEdgeDripicons('Dripicons', 'dripicon'));
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon pack','goodwish'),
        ...
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $key => $collection) {
                $iconSetParams[] = array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Icon','goodwish'),
    ...
    public function getSocialIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack','goodwish'),
            'name'    => 'icon_pack',
    ...
    public function getIconCollectionIcons(iGoodwishEdgeIconCollection $collection) {
    ...
    public function getSearchIcon($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo goodwish_edge_get_module_part($iconsObject->getSearchIcon());
            }
    ...
    public function getSearchClose($iconPack, $return) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo goodwish_edge_get_module_part($iconsObject->getSearchClose());
            }
    ...
    public function getSearchIconValue($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo goodwish_edge_get_module_part($iconsObject->getSearchIconValue());
    ...
    public function getMenuSideIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo goodwish_edge_get_module_part($iconsObject->getMenuSideIcon());
    ...
    public function getBackToTopIcon($iconPack) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            $iconsObject = $this->getIconCollection($iconPack);
			echo goodwish_edge_get_module_part($iconsObject->getBackToTopIcon());
    ...
    public function getMobileMenuIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return) {
				...
				echo goodwish_edge_get_module_part($iconsObject->getMobileMenuIcon());
            }
        }
    ...
    public function getQuoteIcon($iconPack, $return = false) {
        ...
        if($this->hasIconCollection($iconPack)) {
            ...
            if($return == true) {
				...
				echo goodwish_edge_get_module_part($iconsObject->getQuoteIcon());
            }
...
$goodwish_edge_IconCollections = GoodwishEdgeIconCollections::get_instance();