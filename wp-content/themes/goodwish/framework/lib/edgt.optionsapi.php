<?php
if(!function_exists('goodwish_edge_add_admin_page')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeAdminPage
     */
    function goodwish_edge_add_admin_page($attributes) {
        $slug = '';
        $title = '';
        $icon = '';
        ...
        if(isset($slug) && !empty($title)) {
            $admin_page = new GoodwishEdgeAdminPage($slug, $title, $icon);
            goodwish_edge_framework()->edgtOptions->addAdminPage($slug, $admin_page);
...
if(!function_exists('goodwish_edge_add_admin_panel')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgePanel
     */
    function goodwish_edge_add_admin_panel($attributes) {
        $title           = '';
        $name            = '';
        $hidden_property = '';
        $hidden_value    = '';
        ...
        if(isset($page) && !empty($title) && !empty($name) && goodwish_edge_framework()->edgtOptions->adminPageExists($page)) {
            $admin_page = goodwish_edge_framework()->edgtOptions->getAdminPage($page);

            if(is_object($admin_page)) {
                $panel = new GoodwishEdgePanel($title, $name, $hidden_property, $hidden_value, $hidden_values);
...
if(!function_exists('goodwish_edge_add_admin_container')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeContainer
     */
    function goodwish_edge_add_admin_container($attributes) {
        $name            = '';
        $parent          = '';
        $hidden_property = '';
        $hidden_value    = '';
        ...
        if(!empty($name) && is_object($parent)) {
            $container = new GoodwishEdgeContainer($name, $hidden_property, $hidden_value, $hidden_values);
...
if(!function_exists('goodwish_edge_add_admin_twitter_button')) {
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeTwitterFramework
     */
    function goodwish_edge_add_admin_twitter_button($attributes) {
        $name = '';
        $parent = '';
        ...
        if(!empty($parent) && !empty($name)) {
            $field = new GoodwishEdgeTwitterFramework();
...
if(!function_exists('goodwish_edge_add_admin_instagram_button')) {
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeInstagramFramework
     */
    function goodwish_edge_add_admin_instagram_button($attributes) {
        $name = '';
        $parent = '';
        ...
        if(!empty($parent) && !empty($name)) {
            $field = new GoodwishEdgeInstagramFramework();
...
if(!function_exists('goodwish_edge_add_admin_container_no_style')) {
    /**
     * Generates container object
     * $attributes can contain:
     *      $name - name of the container with which it will be added to parent element
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeContainerNoStyle
     */
    function goodwish_edge_add_admin_container_no_style($attributes) {
        $name            = '';
        $parent          = '';
        $hidden_property = '';
        $hidden_value    = '';
        ...
        if(!empty($name) && is_object($parent)) {
            $container = new GoodwishEdgeContainerNoStyle($name, $hidden_property, $hidden_value, $hidden_values);
            $parent->addChild($name, $container);
...
if(!function_exists('goodwish_edge_add_admin_group')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeGroup
     */
    function goodwish_edge_add_admin_group($attributes) {
        $name = '';
        $title = '';
        $description = '';
        $parent = '';
        ...
        if(!empty($name) && !empty($title) && is_object($parent)) {
            $group = new GoodwishEdgeGroup($title, $description);
...
if(!function_exists('goodwish_edge_add_admin_row')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeRow
     */
    function goodwish_edge_add_admin_row($attributes) {
        $parent = '';
        $next   = false;
        $name   = '';
...
if(!function_exists('goodwish_edge_add_admin_field')) {
    /**
     ...
     */
    function goodwish_edge_add_admin_field($attributes) {
        $type            = '';
        $name            = '';
        $default_value   = '';
        $label           = '';
        ...
        if(!empty($parent) && !empty($type) && !empty($name)) {
            $field = new GoodwishEdgeField($type, $name, $default_value, $label, $description, $options, $args, $hidden_property, $hidden_values);
...
if(!function_exists('goodwish_edge_add_admin_section_title')) {
    /**
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeTitle
     */
    function goodwish_edge_add_admin_section_title($attributes) {
        $parent = '';
        $name = '';
        $title = '';
        ...
        if(is_object($parent) && !empty($title) && !empty($name)) {
            $section_title = new GoodwishEdgeTitle($name, $title);
...
if(!function_exists('goodwish_edge_add_admin_notice')) {
    /**
     * Generates GoodwishEdgeNotice object from given parameters
     ...
     * @param $attributes
     *
     * @return bool|GoodwishEdgeNotice
     */
    function goodwish_edge_add_admin_notice($attributes) {
        $title           = '';
        $description     = '';
        $notice          = '';
        $hidden_property = '';
        ...
        if(is_object($parent) && !empty($title) && !empty($notice) && !empty($name)) {
            $notice_object = new GoodwishEdgeNotice($title, $description, $notice, $hidden_property, $hidden_value, $hidden_values);
...
if(!function_exists('goodwish_edge_framework')) {
    /**
     * Function that returns instance of GoodwishEdgeFramework class
     *
     * @return GoodwishEdgeFramework
     */
    function goodwish_edge_framework() {
        return GoodwishEdgeFramework::get_instance();
    }
}

if(!function_exists('goodwish_edge_options')) {
    /**
     * Returns instance of GoodwishEdgeOptions class
     *
     * @return GoodwishEdgeOptions
     */
    function goodwish_edge_options() {
        return goodwish_edge_framework()->edgtOptions;
    }
}
...
if(!function_exists('goodwish_edge_add_multiple_images_field')) {
     ...
     * @return bool|GoodwishEdgeField
     */
    function goodwish_edge_add_multiple_images_field($attributes) {
        $name            = '';
        $label           = '';
        $description     = '';
        $parent          = '';
        ...
        if(!empty($parent) && !empty($name)) {
            $field = new GoodwishEdgeMultipleImages($name,$label,$description);
...
if(!function_exists('goodwish_edge_get_font_weight_array')) {
    /**
     ...
     * @return array
     */
    function goodwish_edge_get_font_weight_array($first_empty = false) {
        $font_weights = array();
...
if(!function_exists('goodwish_edge_get_text_transform_array')) {
    /**
