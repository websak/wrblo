<?php
class ElementorPieChartPie extends \Elementor\Widget_Base {
	private $chartFields = 10;

	public function get_name() {
		return 'edgtf_pie_chart_pie'; 
	}

	public function get_title() {
		return esc_html__( 'Edge Pie Chart (Pie)', 'goodwish' );
	}

	public function get_icon() {
		return 'goodwish-elementor-custom-icon goodwish-elementor-pie-chart-pie';
	}
	...
	public function render() {
		...
		$html = goodwish_edge_get_shortcode_module_template_part('templates/pie-chart-pie', 'pie-chart-pie', '', $params);
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new ElementorPieChartPie() );