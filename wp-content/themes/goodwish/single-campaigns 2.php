...
<style>
  ...
  .objectives .objective p { font-size: 18px;}
</style>
...
<?php if( have_rows('projects') ): ?>
  ...
  $donate_link = get_sub_field('donate_link'); 
  ...
  <section class="scroll-animated fade-in project <?php echo $background;?>" id="project">
                ...
                <p><?//php echo $object["text"]; ?></p>
						...
						<?php endif; ?>
                     <!-- <p><a class="click_tab btn donate-<?//php echo get_row_index(); ?>" href="#donate" target="_blank">Donate</a></p>--></div>
									</div>
							</div>
					</div>
			</section>
